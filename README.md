...
Leave it blank for local development. In production, Chrome Web Store
extension origins are accepted and this list may be used for any additional
trusted browser origin that should reach the API.
